      ...
      <div className="flex flex-col gap-6">
        <div className="flex justify-center">
          <div className="flex justify-center gap-3">
            <button
              type="submit"
              onClick={() => handleAprobar(resEnum.ACEPTAR)}
            ...
            <button
              type="submit"
              onClick={() => handleAprobar(resEnum.CORREGIR)}
            ...
            <button
              type="submit"
              onClick={() => handleAprobar(resEnum.DENEGAR)}
                  ...
                  <td>
                    <div className="flex flex-col">
                      {plan.category?.map((cat, index) => (
                        <span
                          key={index}
                          className="daisy-badge daisy-badge-ghost daisy-badge-sm"
                        >
                          {cat.name}
                        </span>
                      ))}
