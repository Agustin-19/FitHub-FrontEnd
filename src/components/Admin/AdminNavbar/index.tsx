...
const AdminNavbar = () => {
  ...
  return (
    <nav
      className={`navbar fixed top-36 mx-10 shadow-remake ${
        navbarSticky ? "sticky" : ""
      }`}
    >
          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border rounded-lg md:flex-row rtl:space-x-reverse md:mt-0 md:border-0">
            <li>
              <Link
                ...
                className={`navbar-boton ${
                  activeButton === "/admin/coachs" ? "active" : ""
                }`}
            ...
            <li>
              <Link
                href="/admin/routines"
                className={`navbar-boton ${
                  activeButton === "/admin/routines" ? "active" : ""
                }`}
            ...
            <li>
              <Link
                href="/admin/plans"
                className={`navbar-boton ${
                  activeButton === "/admin/plans" ? "active" : ""
                }`}
            ...
            <li>
              <Link
                ...
                className={`navbar-boton ${
                  activeButton === "/admin/dashboard" ? "active" : ""
                }`}
